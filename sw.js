const CACHE='dog-racehub-v2-0-1';
const CORE=['./','./index.html','./style.css?v=2.0.1','./app.js?v=2.0.1','./lang.js?v=2.0.1','./config.js?v=2.0.1','./manifest.webmanifest','./icon-192.png'];
