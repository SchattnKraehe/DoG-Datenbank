const CACHE='dog-racehub-v1-89';
const CORE=['./','./index.html','./style.css?v=1.89','./app.js?v=1.89','./lang.js?v=1.89','./manifest.webmanifest','./dog-logo.png','./flag-de.png','./flag-ch.png','./flag-es.png','./flag-at.png','./flag-gb.png','./flag-dk.png','./flag-se.png','./flag-no.png','./flag-pl.png'];
