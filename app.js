...
function save(){syncTeamChiefRoles();reconcileCurrentRoster();normalizeAllRacePoints();saveLocalCache();return editor?cloudSave():Promise.resolve(false);} ensureRaceMetadata(); load(); syncTeamChiefRoles();
